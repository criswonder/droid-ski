...
public interface SharedPreferencesCompat {
	...
	static class SharedPreferencesWrapper implements SharedPreferencesCompat {
	...
	static class EditorCompatWrapper implements EditorCompat {
		...
		@Override public Editor putStringSet(String key, Set<String> values) {
			...
			for (String value : values)
				joiner.append(STRING_SET_COMPAT_SEPARATOR).append(value);
